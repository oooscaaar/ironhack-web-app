...
class Validator {
  constructor() {
    ...
    this.invalidEmailError = 'Invalid mail address';
    this.emailExistsError = 'The address mail is already registered';
    this.passwordError = 'Password must be 6 characters long at least';
